...
function formatL2HVAC(d) {
    ...
    const res = raw.map((v, i) => {
        let val = v; if ((CONFIG.NO_EQUIPMENT[d.name] || []).some(ex => i === 2 || i === 5)) val = "N/A";
